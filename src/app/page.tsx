        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { name: t('product_mood_name'), tagline: t('product_mood_tagline'), url: 'https://apps.apple.com/us/app/mood-balloon/id6755811908', status: t('products_status_live'), statusColor: 'bg-green-100 text-green-700', color: '#E8A87C', logo: '/img/mood-balloon-logo.png', isAppIcon: true },
            ].map((product, index) => (
              <Link
